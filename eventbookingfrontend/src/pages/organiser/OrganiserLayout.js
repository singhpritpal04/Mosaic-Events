...
export default function AdminLayout() {
    function logOutOrganiser() {
        axios.post("http://localhost:4000/logout-organiser").then((response) => {
                        ...
                        <div className="navi-agiles">
                            ...
                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul className="navbar-nav mr-lg-auto text-center">
                                    ...
                                    <li className="nav-item active">
                                        <NavLink className="nav-link" to={"/organiser"}><FaHome size={30} color='white'/> Home
                                    ...
                                    <li className="nav-item dropdown">
                                        ...
                                        <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <NavLink className="dropdown-item scroll"
                                                     to={"/organiser/add-event"}><IoIosPersonAdd size={30}
                                                                                                 color='coral'/> Add
                                                Event</NavLink>

                                            <NavLink className="dropdown-item scroll"
                                                     to={"/organiser/view-event"}><MdOutlinePreview size={30}
                                                                                                    color='coral'/> View
                                                Event</NavLink>
                                    ...
                                    <li className="nav-item  mx-xl-4 mx-lg-2">
                                        <NavLink className="nav-link scroll" to={"/#gallery"}><FcGallery size={30} color='white'/> Gallery</NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink className="nav-link scroll" to="change-organiser-password"><FaEdit size={30} color='white'/> Change
                                            Password</NavLink>
                                    </li>
                                    <li className="nav-item ml-xl-4 ml-lg-2">
                                        <NavLink className="nav-link scroll" to="/organiser/organiser-login"
                                                 role={"button"} onClick={logOutOrganiser}><FiLogOut size={30}
